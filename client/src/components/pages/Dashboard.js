                ...
                <div className='row'>
                    <div className='col'>
                        ...
                        <div className="border border-dark text-center m-2 p-3">
                            ...
                            <Link to="/addbook" className="btn btn-success btn-outline-dark text-white">Add Books</Link>
            ...
            return (
              <div className="card m-3 p-2" key={book._id}>
                ...
                <div className="card-body">
                  ...
                  <Link to={`/books/${book._id}`} className="btn btn-primary m-3 p-2">
                    Update
                  </Link>
                  <button onClick={handleDeleteBook.bind(this,book._id)} className="btn-danger m-3 p-2">Delete</button>
                </div>
              </div>
            );
          })}
